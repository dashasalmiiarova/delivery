...
public class CustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(CustomerActivity.this, "Registration is sucsessfull", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                cAuth.signInWithEmailAndPassword(cEmail.getText().toString(),
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(CustomerActivity.this, "Login is sucsessfull", Toast.LENGTH_SHORT).show();
        ...
        cRecoverP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CustomerActivity.this, RecoverPassCActivity.class));
            }
        });
    }
}
